...
public class RegistrationData {
	...
	public int grade;
	public Long userId;	// ID of user who is exception to email/username validation

	public RegistrationData() {}
	public RegistrationData(String email, String username, String password, String passwordRepeat, String firstName, String lastName, int grade, Long userId) {
		this.email = email;
